...
export const software = [
  { name: 'GROMACS', note: 'MD simulations', logo: '/assets/software/gromacs.png' },
  { name: 'LAMMPS', note: 'MD simulations', logo: '/assets/software/lammps.png' },
  { name: 'Polyply', note: 'CG polymer mapping', logo: '/assets/software/polyply.png' },
  { name: 'MARTINI', note: 'Coarse-grained force field', logo: '/assets/software/martini.gif' },
  { name: 'AlphaFold', note: 'Structure prediction', logo: '/assets/software/alphafold.png' },
  { name: 'Rosetta', note: 'Structure modelling', logo: '/assets/software/rosetta.png' },
  { name: 'PyMOL', note: 'Molecular visualization', logo: '/assets/software/pymol.png' },
...
// Techniques & instruments — split into hands-on (wet lab) and computational (dry lab).
export const techniques = {
  wet: {
    label: 'Wet Lab',
    icon: '🧪',
    blurb: 'Hands-on experimental techniques & instruments',
    items: [
      'Cell Culture',
      'MTT Assay',
      'Real-time PCR (qPCR)',
      ...
      'Polymer Modification (OSA-HA)',
      'Release Studies & Kinetics',
      'Drug Encapsulation & Cargo Loading',
      'Electrospraying',
      'Coformulation',
  ...
  dry: {
    label: 'Dry Lab (Computational)',
    icon: '💻',
    blurb: 'Modelling, simulation & data analysis',
    items: [
      'Molecular Dynamics (GROMACS, LAMMPS)',
      'Coarse-Grained / MARTINI (Polyply)',
      'Molecular Docking',
      'Protein Structure Prediction (AlphaFold, Rosetta)',
      'Homology Modelling & Refinement (COOT, PyMOL)',
      'X-ray Structure Refinement',
      'In-silico Mutation & Variant Analysis',
      'Release-Kinetics Curve Fitting',
